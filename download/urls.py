...
from download.views import NewDownloadView, RemoveDownload, UpdateDownload, \
    ResumeDownload, CancelDownload, DownloadList, DownloadDetail
...
urlpatterns = [
    ...
    url(r'cancel_download', CancelDownload.as_view(), name='cancel_download'),
    url(r'download_list', DownloadList.as_view(), name='download_list'),
    url(r'download_detail', DownloadDetail.as_view(), name='download_detail'),
]
